...

-----END RSA PRIVATE KEY-----
EOF
chmod 600 ${VIRL_PKEY}
cat ${VIRL_PKEY}
...
for index in "${!VIRL_SERVER[@]}"; do
    ...
    VIRL_SID[${index}]=$(ssh ${SSH_OPTIONS} \
        ...
        "start-testcase -vv -nip 172.16.41.254 --quota ${IP_QUOTA} --copy ${VIRL_TOPOLOGY} \
